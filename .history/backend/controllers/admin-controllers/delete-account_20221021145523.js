  ...
  try {
    ...
    if (accountDeleted) {
      ...
      if (rule === "COMPANY") {
        ...
        await CompanyAssess.findOneAndDelete({ companyId: accountDeleted._id }); //deletemany
        await FormRegister.findOneAndDelete({ companyId: accountDeleted._id }); //deleteny
        await StudentAccount.findOneAndUpdate({ companyId: "" }); //sai
      }
      ...
      if (rule === "STUDENT") {
        ...
        await FormRegister.findOneAndDelete({ studentId: accountDeleted._id }); //many
