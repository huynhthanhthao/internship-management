        ...
        <div class="infor row col-12 border-bottom pb-3">
            ...
            <div class="manage-internship col-6 d-flex justify-content-center align-items-center mb-4 mx-auto">
                <div class="col-3 me-5">
                    <router-link to="/student/manage/view-progress" class="text-decoration-none" :style="{ cursor: 'default'}">
                ...
                <div class="col-3 me-5">
                    <router-link to="/student/manage/view-assess-company" class="text-decoration-none" :style="{ cursor: 'default'}">
                ...
                <div class="col-3 m-2">
                    <router-link to="/student/manage/view-assess-teacher" class="text-decoration-none" :style="{ cursor: 'default'}">
                        <button type="button" class="btn btn-primary" @click="viewInforInternship($event)">
                            <i class="bi bi-eye fs-2 me-2"></i>
