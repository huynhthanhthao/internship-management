<template>
  <div class="login py-5 col-sm-8 m-auto d-flex flex-column align-items-center">
    <h2 class="login__title fs-4s fw-semibold" style="color:#555">Chào mừng đến với <span style="color: #1f5cca">CTU</span> <span style="color: #00b0f0">M-INTERNSHIP</span> !</h2>
