<template>
  <div class="teacher-update my-5 animate__animated animate__fadeIn" >
    ...
    <div class="form-update col-6 mt-5 p-4 rounded-5 m-auto row d-flex justify-content-between">
      <AvatarComponent :avatar="avatar" class="col-3"/>
      <form class="form-update-infor col-7" >
          <div class="mb-3 ">
