      ...
      <div class="teacher-manage__content row">
        <div class="teacher-student-list col-6">
          <div class="teacher-student-class">
            <button type="button" class="btn btn-primary col-2 m-4">DI1996A1</button>
            <button type="button" class="btn btn-primary col-2 m-4">DI1996A2</button>
            <button type="button" class="btn btn-primary col-2 m-4">DI1996A3</button>
            <button type="button" class="btn btn-primary col-2 m-4">DI1996A3</button>
            <button type="button" class="btn btn-primary col-2 m-4">DI1996A3</button>
          </div>
