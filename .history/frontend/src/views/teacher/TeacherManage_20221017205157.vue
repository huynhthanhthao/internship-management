  ...
  <div class="teacher-manage p-4" >
      ...
      <div class="teacher-manage__content row">
        <div class="teacher-student-list col-6">
          <div class="teacher-student-class d-flex justify-content-between">
            <button type="button" class="btn btn-primary">DI1996A1</button>
            <button type="button" class="btn btn-primary">DI1996A2</button>
            <button type="button" class="btn btn-primary">DI1996A3</button>
          </div>
