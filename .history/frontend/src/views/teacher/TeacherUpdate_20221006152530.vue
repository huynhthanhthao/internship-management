<template>
  <div class="teacher-update my-5 animate__animated animate__fadeIn" >
    ...
    <div class="form-update col-6 mt-5 p-4 rounded-3 m-auto row d-flex justify-content-center">
      ...
      <form class="form-update-infor ms-5 col-6 " >
          ...
          <div class="mb-3">
            <label for="avatar" class="form-label mb-2"><strong>Cập nhật ảnh đại diện</strong></label>
