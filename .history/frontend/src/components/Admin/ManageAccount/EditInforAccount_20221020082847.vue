        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" class="row col-12  p-0 my-3 mx-2">
                    <div class="avatar col-4 d-flex flex-column align-items-center ps-0 me-4">
                        <AvatarComponent :avatar="avatar" class="col-12" />
                        <input type="text" id="fullName" class="fullName col-12 text-center fs-5 fw-bold mt-3" value="Trần Nguyễn Nguyên Minh">
                    </div>
