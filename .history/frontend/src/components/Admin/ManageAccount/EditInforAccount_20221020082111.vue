            ...
            <div class="modal-body">
                <form action="" class="row col-12  p-0 my-3 mx-2">
                    ...
                    <div class="infor col-7">
                        ...
                        <div class="mb-3 row">
                            <label for="inputTypeAccount" class="col-1 col-form-label px-0 ms-auto"><strong>Loại tài khoản</strong></label>
                            <select class="form-select" aria-label="Select Type Account" id="inputTypeAccount">
