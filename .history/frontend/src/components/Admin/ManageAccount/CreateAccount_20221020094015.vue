        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalLabel">Thêm tài khoản</h1>
                        ...
                        <div class="infor col-6">
                            ...
                            <div class="mb-3 row">
                                <label for="inputTypeAccount" class="col-3 col-form-label px-0"><strong>Tài
                                        khoản:</strong></label>
                                <div class="col-9">
                                    <select class="form-select select-type-account" aria-label="Select Type Account" id="inputTypeAccount">
...
export default {
    ...
    computed(){
        const typeAccountSelect = document.querySelector('.select-type-account')
        console.log(typeAccountSelect)
        // if (typeAccountSelect)
        //     typeAccountSelect.addEventListener('change', function () {
        //     if(this.value == 2)
        //         document.querySelector('student-class').classList.remove("d-none");
        //     else{
        //         document.querySelector('student-class').classList.add("d-none");
        //     }
        // });
    }
}
