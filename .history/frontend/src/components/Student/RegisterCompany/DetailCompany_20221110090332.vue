    ...
    <div class="detail-company" v-if="showCompany">
        <div
            ...
            <div class="col-12 d-flex justify-content-around pt-2">
                <button type="button" class="btn btn-info rounded-5" v-if="company.id === student.companyId" disabled>
                    Sinh viên đang thực tập
                </button>
                <button type="button" class="btn-warning" v-else-if="student.companyId!==null" disabled>
