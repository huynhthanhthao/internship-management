...
export default {
    name: "ViewProgress",
    computed: {
        ...mapGetters({tasks: "getProgressInfor", student: "getStudentInfor", companyAccess: "getCompanyAccess"}),
        startDate() {
