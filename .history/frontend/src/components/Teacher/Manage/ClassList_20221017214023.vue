<template>
  <div class="classes">
    <i class="bi bi-arrow-right-circle classes__icon classes--prev is-hidden"></i>
    ...
    <i class="bi bi-arrow-left-circle classes__icon classes--next"></i>
  </div>
</template>
...
export default {
    ...
    mounted(){
        window.addEventListener("load", function () {
            const nav = document.querySelector(".class");
