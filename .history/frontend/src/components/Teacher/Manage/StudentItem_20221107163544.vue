        ...
        <div class="accordion-item">
            <h2 class="accordion-header" :id="`heading${index}`">
                <button class="accordion-button collapsed p-3" type="button" data-bs-toggle="collapse"
                    ...
                    <img :src="`${student.urlAvatar}`" alt="" class="me-2" style="width: 30px" />
            ...
            <div :id="`collapse${index}`" class="accordion-collapse collapse" :aria-labelledby="`heading${index}`"
                ...
                <div class="accordion-body row">
                    ...
                    <div class="col-12">
                        <strong>Đơn vị thực tập: </strong> {{student.companyName}} 
                    </div>
                    <div class="col-12 d-flex justify-content-center mt-4">
                        <button type="button" class="btn btn-outline-secondary p-2" style="font-size: 15px" @click="showDetail(student)">
                            Xem chi tiết
                        </button>
                    </div>
                </div>
