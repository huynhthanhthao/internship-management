...
<div class="assess-teacher animate__animated animate__fadeIn my-4">
    ...
    <div class="assess-teacher__detail my-4 ">
        ...
        <p class="assess-teacher__status" v-if="completedAssess"><strong>Trạng thái đánh giá:</strong> 
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>0.5</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[1]"></td>
                </tr>
                <tr>
                    <th scope="row">I.2</th>
                    <td>Trình bày mạch lạc, súc tích, không có lỗi chính tả</td>
                    <td>0.5</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[2]" ></td>
                </tr>
                <tr style="font-weight: bold">
                    <th scope="row">II</th>
                ...
                <tr>
                    ...
                    <td>0.25</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[4]" ></td>
                </tr>
                <tr>
                    <th scope="row">II.2</th>
                    <td>Số buổi thực tập tại cơ quan trong 1 tuần >=6; ít hơn 6 buổi 0.0 điểm</td>
                    <td>1.0</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[5]"></td>
                </tr>
                <tr>
                    ...
                    <td>3.5</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[6]" ></td>
                </tr>
                <tr style="font-weight: bold">
                    <th scope="row">III</th>
                ...
                <tr>
                    ...
                    <td>0.5</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[8]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.2</th>
                    <td>Phương pháp thực hiện phù hợp với nội dung công việc được giao</td>
                    <td>1.0</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[9]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.3</th>
                    <td>Kết quả củng cố lý thuyết</td>
                    <td>0.5</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[10]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.4</th>
                    <td>Kết quả rèn luyện kỹ năng thực hành</td>
                    <td>0.5</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[11]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.5</th>
                    <td>Kinh nghiệm thực tiễn thu nhận được</td>
                    <td>0.5</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[12]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.6</th>
                    <td>Kết quả công việc có đóng góp cho cơ quan nơi thực tập</td>
                    <td>1.25</td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[13]" ></td>
                </tr>
                <tr>
                    <th></th>
                    <td >Cộng</td>
                ...
                <tr>
                    ...
                    <td >Điểm trừ</td>
                    <td></td>
                    <td><input type="number" class="w-100 form-control" v-model="assessPoint[15]"></td>
                </tr>
                <tr>
                    <th></th>
                    <td >Điểm còn lại</td>
