...
<div class="assess-teacher animate__animated animate__fadeIn my-4">
    ...
    <div class="assess-teacher__detail my-4 ">
        <p class="assess-teacher__date"><strong>Thời gian thực tập:</strong>
            <span> từ ngày {{ startDate }}</span>
            <span v-if="tasks.length >= 8"> đến ngày {{ endDate }}</span>
        </p>
        <p class="assess-teacher__status"><strong>Trạng thái đánh giá:</strong> 
            <span style="color: red" v-if="assessPoint[16]===undefined"> Chưa đánh giá</span>
            <span style="color: green" v-if="completedAssess && assessPoint[16] !== undefined"> Đã đánh giá</span>
        </p>
        <p style="color: red" v-if="!completedAssess">Giảng viên chưa thể đánh giá vì đơn vị thực tập chưa hoàn tất đánh giá.</p>
    </div>
    <form v-if="completedAssess" class="table-assess border rounded-4 p-3 col-9 d-flex m-auto flex-column">
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>0.5</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[1]"></td>
                </tr>
                <tr>
                    <th scope="row">I.2</th>
                    <td>Trình bày mạch lạc, súc tích, không có lỗi chính tả</td>
                    <td>0.5</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[2]" ></td>
                </tr>
                <tr style="font-weight: bold">
                    <th scope="row">II</th>
                ...
                <tr>
                    ...
                    <td>0.25</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[4]" ></td>
                </tr>
                <tr>
                    <th scope="row">II.2</th>
                    <td>Số buổi thực tập tại cơ quan trong 1 tuần >=6; ít hơn 6 buổi 0.0 điểm</td>
                    <td>1.0</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[5]"></td>
                </tr>
                <tr>
                    ...
                    <td>3.5</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[6]" ></td>
                </tr>
                <tr style="font-weight: bold">
                    <th scope="row">III</th>
                ...
                <tr>
                    ...
                    <td>0.5</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[8]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.2</th>
                    <td>Phương pháp thực hiện phù hợp với nội dung công việc được giao</td>
                    <td>1.0</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[9]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.3</th>
                    <td>Kết quả củng cố lý thuyết</td>
                    <td>0.5</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[10]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.4</th>
                    <td>Kết quả rèn luyện kỹ năng thực hành</td>
                    <td>0.5</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[11]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.5</th>
                    <td>Kinh nghiệm thực tiễn thu nhận được</td>
                    <td>0.5</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[12]" ></td>
                </tr>
                <tr>
                    <th scope="row">III.6</th>
                    <td>Kết quả công việc có đóng góp cho cơ quan nơi thực tập</td>
                    <td>1.25</td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[13]" ></td>
                </tr>
                <tr>
                    <th></th>
                    <td >Cộng</td>
                ...
                <tr>
                    ...
                    <td >Điểm trừ</td>
                    <td></td>
                    <td><input type="text" class="w-100 form-control" v-model="assessPoint[15]"></td>
                </tr>
                <tr>
                    <th></th>
                    <td >Điểm còn lại</td>
        ...
        <button type="submit" class="btn btn-primary col-2 ms-auto" @click="assess($event)">Lưu Đánh Giá</button>
    </form>
</div>
</template>
    ...
    methods: {
        ...
        setAssessPoint() {
            ...
            this.assessPoint = this.assessPoint.map((point) => {
                point = isNull(point) || point==="" || isNaN(parseFloat(point))? 0: point;
            ...
            this.assessPoint.forEach((point, index) => {
                switch (index) {
                    ...
                    case 8: case 9: case 10: case 11: case 12: case 13: 
                        ...
                        break;
                    case 14:
                        this.assessPoint[index] = this.assessPoint[0] + this.assessPoint[3] + this.assessPoint[7];
                        break;
                    case 16: 
                        this.assessPoint[index] = this.assessPoint[14] - this.assessPoint[15];
                        break;
                }
            });
        },
