<template>
  <div class="teacher-detail-student" v-if="getDetailStudent">
    <div
        class="information-detail position-relative rounded-2 p-3 py-4 row col-12 animate__fadeIn animate__animated "
    >
        <button
            type="button"
        ...
        <div class="col-12 d-flex justify-content-around">
          <button type="button" class="btn btn-outline-secondary">Xem tiến độ thực tập</button>
...
export default {
    ...
    methods: {
      ...mapMutations({closeDetail:"CLOSE_DETAIL_STUDENT"})
    }
}
</script>
