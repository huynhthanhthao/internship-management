<template>
<div class="assess-teacher animate__animated animate__fadeIn" v-if="!getShowAssess">
    ...
    <div class="assess-teacher__detail my-4 ">
        <p class="assess-teacher__infor"><strong>Giảng viên chấm báo cáo: </strong>Nguyễn Văn A</p>
        <p class="assess-teacher__date"><strong>Thời gian thực tập:</strong> từ ngày 19-05-2022 đến 20-07-2022</p>
        <p class="assess-teacher__status"><strong>Trạng thái hoàn thành:</strong> <span style="color: red">Chưa hoàn thành đánh giá</span></p>
        <button type="button" class="btn btn-primary" @click="showAssess">Xem đánh giá của đơn vị</button>
    </div>
    <form class="table-assess border rounded-4 p-3 col-8 d-flex m-auto flex-column">
        <table class="table">
            <thead>
                <tr>
        ...
        <button type="submit" class="btn btn-primary col-2 ms-auto">Lưu Đánh Giá</button>
    </form>
</div>
</template>
