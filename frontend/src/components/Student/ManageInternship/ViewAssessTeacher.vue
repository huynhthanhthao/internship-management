<template>
    <div class="view-assess-teacher animate__animated animate__fadeIn my-4">
        ...
        <div class="assess-teacher__detail mb-4">
            <p class="assess-teacher__date" v-if="startDate"><strong>Thời gian thực tập:</strong> 
            ...
            <p class="assess-teacher__status" v-if="startDate"><strong>Trạng thái hoàn thành:</strong> 
                <span v-if="points.length===0" style="color: red"> Chưa hoàn thành đánh giá</span>
                <span v-else style="color: green"> Đã hoàn thành đánh giá</span>
            </p>
        </div>
        <div class="border table-assess col-8 rounded-4 p-3 mx-auto my-3 d-flex flex-column" v-if="startDate">
            <table class="table">
                <thead>
                    <tr>
...
export default {
    ...
    computed:{
        ...mapGetters({
            points: "getTeacherAssess", student: "getStudentInfor",
